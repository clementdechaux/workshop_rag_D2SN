...
if __name__ == "__main__":
    source_path = "./data/sources/wikipedia_clement/*.txt"
    ...
    qa = []
    bad_formatted = []
    for n, context in enumerate(allchunks[:10]):
        gen = Generate()
    ...
    # save to json
    output_file_json = "./data/rag/questions_transports_paris_12032024.json"
